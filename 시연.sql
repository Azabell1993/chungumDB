...
select MEMBER_ORDERNUM FROM SONNIM S WHERE MEMBER_ID = 'testUser03';
...
-- 하루 총 매출
SELECT SUM(ORDER_PAY) FROM SUBMIT_ORDER WHERE ORDER_DATE LIKE '%2023-03-13%'; -- 572,500

SELECT * FROM SUBMIT_ORDER SO ;

select MEMBER_ORDERNUM FROM SONNIM S WHERE MEMBER_ID = 'testUser01'

SELECT * FROM SONNIM S ;


-- 중간 점검
1	testUser00	29	127800
2	testUser03	32	145400
3	testUser02	25	93500
4	testUser01	54	205800
...
5	testUser00	15	81000
6	testUser01	54	205800
7	testUser02	10	45000
8	testUser03	12	54000


SELECT SUM(ORDER_PAY) FROM SUBMIT_ORDER WHERE ORDER_DATE LIKE '%2023-03-13%';  -- 958,300
